...
export const GLOBAL_COMMANDS: ReadonlyArray<BrainCommandSpec> = [
  ...
  { type: 'LEER_BANDEJA',        description: 'Listar y leer los correos recibidos en la bandeja.', examples: ['leer bandeja', 'ver bandeja', 'bandeja', 'leeme la bandeja', 'mostrame la bandeja', 'bandeja de entrada', 'que correos tengo', 'fijate si llego algo', 'lee mis mensajes'] },
  ...
  { type: 'ABRIR_ENTRENADOR',    description: 'Abrir el entrenador de voz: la persona entrena los comandos con su propia voz y ve las metricas (confianza y efectividad) de cada uno.', examples: ['abrir entrenador', 'entrenar mi voz', 'entrenar los comandos', 'quiero que aprenda como hablo', 'entrenamiento de voz'] },
